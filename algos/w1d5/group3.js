Names: Umer Mahmood, Justin Clayton
...
function quickSort(arr, left = 0, right = arr.length - 1) {
    if (left < right) {
        let pivotIdx = PartitionLomuto(arr, left, right);
    ...
    // Radix Sort
    // https://www.cs.usfca.edu/~galles/visualization/RadixSort.htmlrtirr.ruicks
    ...
    var unsort = [4, 7, 1, 8, 9, 2, 0, 3, 6, 5];
