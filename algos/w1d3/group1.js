//Hana L. / Dallas MArtinez/ Jim Hartung // Array: Merge Sort
...
// whoops i dropped my solution on your group! -brendan
...
function mergeSortedArrays(arr1, arr2) {
    ...
    // is still mostly full, ex: [1,2,3] and [4,5,6]
...
// var l = arr.slice(0, m);
// var r = arr.slice(m):ay: Merge Sort
// visualization: https://www.hackerearth.com/practice/algorithms/sorting/merge-sort/visualize/
// multiple sorts, visualized: https://i.imgur.com/fq0A8hx.gif

Hana and James and Dallas // Array: Merge Sort
// visualization: https://www.hackerearth.com/practice/algorithms/sorting/merge-sort/visualize/
// multiple sorts, visualized: https://i.imgur.com/fq0A8hx.gif
...
//var arrOrig =[], var left = int1, var right = int2
function mergeSort(arrOrig, left, right) {
    if (right > left)
...
function mergeSort(arr) {
    ...
    var arr1 = mergeSort(arr, 1, middle);
    var arr2 = mergeSort(arr, middle + 1, )
