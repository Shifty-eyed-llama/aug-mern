// Group 7:Yan Yee Kwok (Beverly),  Jennifer Joy ,  Umer Mahmood
//Array: Merge Sort
...
function mergeSortedArrays(arr1, arr2) {
    //first combine both arrays arbitrarily to have one to work with
    // for loop to traverse forward through half of array
    //second loop to traverse backward to half point
    //compare all values in each index to find lowest value
    //
}
...
// var l = arr.slice(0, m);
// var r = arr.slice(m)=1;1()e=ar[][j]a1sefirre